    ...
    <div class="container">
        ...
        <div class="row justify-content-center mb-2">
            ...
            <div class="col-lg-12">
                ...
                <div class="card mb-0 border-0 mb-3 mt-3 mt-3" style="z-index:999">
                                    ...
                                    <div class="col-md-4 mb-3 {{$bs['kode_objek']}}">
                                        <div class="card mb-2">
                                            ...
                                            <div class="card-header text-white px-3 py-1" style="background: #8f8f8f">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <h5 class="mb-0 text-center">Kode Bidang LL-00{{$bs['id']}}<img src="{{asset('')}}uploads/biru_centang.png" alt="" class="mb-1" style="height:20px"></h5>
                                                    </div>
                                                </div>
                                            </div>
