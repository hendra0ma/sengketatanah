                ...
                <div class="row g-2 mt-2 desktop">
                    ...
                    <div class="col-auto">
                        <form action="{{url('')}}/daftar-jasa"
                            method="get" id="form-notaris">
                            <input type="hidden" name="title"
                                value="Notaris">
                        </form>
                        <a onclick="return $('form#form-notaris').submit()" class="btn" style="background-color: #61481C; color: #fff">Daftar Sekarang</a>
                    </div>
                ...
                <div class="row g-0">
                    <div class="col-auto ms-auto" style="margin-top:5px">
                        <div class="d-grid gap-2 me-1">
                            <a onclick="return $('form#form-notaris').submit()" class="btn btn-sm btn-outline-brown rounded-5 fw-bold">Daftar Sekarang</a>
                        </div>
                    </div>

                    <div class="col me-auto" style="margin-top:5px">
                        <div class="ms-1 d-grid gap-2">
                            <a class="btn btn-sm btn-outline-brownie rounded-5 fw-bold" href="{{url('')}}/join">Pelajari Jasa Notaris</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        $('select#kota').on('change', function () {
                            ...
                            $.ajax({
                                ...
                                success: function (datas) {
                                    ...
                                    $('input[name=kota]').val($('select#kota option:selected')
                                    .text());
                                }
                            ...
                            $.ajax({
                                ...
                                success: function (datas) {
                                    ...
                                    $('input[name=kecamatan]').val($(
                                            'select#kecamatan option:selected')
                                        .text());
                                }
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm">
                                                    ...
                                                    <table style="width:100%">
                                                        <tr>
                                                            <td rowspan="3">
                                                                <form action="{{url('')}}/detail-main-petugas"
                                                                    method="get" id="form-notaris-{{$i}}">
                                                                    <input type="hidden" name="name"
                                                                        value="{{$name[$i]}}">
                                                                    <input type="hidden" name="img"
                                                                        value="https://randomuser.me/api/portraits/men/{{$i}}.jpg">
                                                                    <input type="hidden" name="jenis_petugas"
                                                                        value="Notaris">
                                                                </form>
                                                                <img onclick="return  $('form#form-notaris-<?= $i ?>').submit()"
                                                                    src="https://randomuser.me/api/portraits/men/{{$i}}.jpg"
                                                                    class="rounded-circle img-thumbnail "
                                                                    style="width:70px;height:auto;object-fit:cover;cursor: pointer;">
                                                            </td>
                                                            <td>
                                                                <b onclick="return  $('form#form-notaris-<?= $i ?>').submit()"
                                                                    style="cursor: pointer;" class="ms-1 text-success">
                                                                    {{$name[$i]}}
                                                                </b>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button class="mobile btn btn-outline-dark float-end"
                                                                    onclick="return $($(this).parent()).find('form').submit()">
                                                ...
                                                <div class="col-auto">
                                                    <div class="desktop">
                                                        <div class="float-end">
                                                            ...
                                                            <button
                                                                onclick="return $($(this).parent()).find('form').submit()"
                                                                class="btn btn-outline-dark pt-1 pb-1 mt-0 mb-0">
                                                                <i class="fa fa-comment"></i>
                                                                Hubungi
                                                            </button>
                                                        </div>
