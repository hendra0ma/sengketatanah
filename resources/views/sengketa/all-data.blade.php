        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-12">
                ...
                <div class="row g-2 mt-2 desktop">
                    ...
                    <div class="col-auto">
                        <a href="{{url('')}}/pilih-user-sponsor" class="btn" style="background-color: #61481C; color: #fff">Daftar Sekarang</a>
                    </div>
            ...
            <div class="row g-0">
                <div class="col-auto ms-auto" style="margin-top:5px">
                    <div class="d-grid gap-2 me-1">
                        <a href="{{url('')}}/pilih-user-sponsor" class="btn btn-sm btn-outline-brown rounded-5 fw-bold">Daftar Sekarang</a>
                    </div>
                </div>
                            ...
                            <div class="col-md-4 mb-3 {{$bs['kode_objek']}}">
                                ...
                                <div class="desktop-2">
                                    <div id="carouselExampleControls{{$bs['id']}}" class="carousel slide" data-bs-interval="false">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img src="{{$bs['img']}}" class="d-block w-100 image-kunam" data-bs-toggle="modal" data-bs-target="#image-modal" data-src="{{asset('')}}images/lahan1.jpeg" data-bs-toggle="modal" data-bs-target="#image-modal" data-src="{{asset('')}}images/lahan1.jpeg" style="height:250px;width:auto;object-fit:cover">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="{{$bs['img1']}}" class="d-block w-100 image-kunam" data-bs-toggle="modal" data-bs-target="#image-modal" data-src="{{asset('')}}images/lahan1.jpeg" data-bs-toggle="modal" data-bs-target="#image-modal" data-src="{{asset('')}}images/lahan1.jpeg" style="height:250px;width:auto;object-fit:cover">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="{{$bs['img2']}}" class="d-block w-100 image-kunam" data-bs-toggle="modal" data-bs-target="#image-modal" data-src="{{asset('')}}images/lahan1.jpeg" data-bs-toggle="modal" data-bs-target="#image-modal" data-src="{{asset('')}}images/lahan1.jpeg" style="height:250px;width:auto;object-fit:cover">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="{{$bs['img3']}}" class="d-block w-100 image-kunam" data-bs-toggle="modal" data-bs-target="#image-modal" data-src="{{asset('')}}images/lahan1.jpeg" data-bs-toggle="modal" data-bs-target="#image-modal" data-src="{{asset('')}}images/lahan1.jpeg" style="height:250px;width:auto;object-fit:cover">
                                            </div>
                                        </div>
                                ...
                                <div class="mobile">
                                    <div id="carouselmobile{{$bs['id']}}" class="carousel slide" data-bs-interval="false">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img src="{{$bs['img']}}" class="d-block w-100 image-kunam" data-bs-toggle="modal" data-bs-target="#image-modal" data-src="{{asset('')}}images/lahan1.jpeg" data-bs-toggle="modal" data-bs-target="#image-modal" data-src="{{asset('')}}images/lahan1.jpeg" style="height:210px;width:auto;object-fit:cover">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="{{$bs['img1']}}" class="d-block w-100 image-kunam" data-bs-toggle="modal" data-bs-target="#image-modal" data-src="{{asset('')}}images/lahan1.jpeg" data-bs-toggle="modal" data-bs-target="#image-modal" data-src="{{asset('')}}images/lahan1.jpeg" style="height:210px;width:auto;object-fit:cover">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="{{$bs['img2']}}" class="d-block w-100 image-kunam" data-bs-toggle="modal" data-bs-target="#image-modal" data-src="{{asset('')}}images/lahan1.jpeg" data-bs-toggle="modal" data-bs-target="#image-modal" data-src="{{asset('')}}images/lahan1.jpeg" style="height:210px;width:auto;object-fit:cover">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="{{$bs['img3']}}" class="d-block w-100 image-kunam" data-bs-toggle="modal" data-bs-target="#image-modal" data-src="{{asset('')}}images/lahan1.jpeg" data-bs-toggle="modal" data-bs-target="#image-modal" data-src="{{asset('')}}images/lahan1.jpeg" style="height:210px;width:auto;object-fit:cover">
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-items-center" rowspan="2">
                                                ...
                                                <div class="row d-flex  align-items-center mb-2">
                                                    ...
                                                    <div class="col">
                                                        <button class="btn float-end text-white mb-0" data-bs-toggle="modal" style="background-color: #61481C; color: #fff" data-bs-target="#exampleC">
                                                            &nbsp;&nbsp;&nbsp;Bid&nbsp;&nbsp;&nbsp;</button>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row g-0">
                                        <div class="col text-center">
                                            ...
                                            <a href="#" class=" mx-auto btn rounded-5" data-bs-toggle="modal" data-bs-target="#berkasSponsor" style="text-decoration:none;background-color: #BF9742; color: #fff">
                                        ...
                                        <div class="col text-center">
                                            <span onclick="return document.querySelector('form.form-sengketa<?= $bs['id'] ?>').submit()" class="btn rounded-5" style="cursor:pointer; background-color: #BF9742; color: #fff"><i class="fa-solid fa-play text-white"></i> Lihat
                                                Podcast</span>
                                        </div>
                                    </div>
        ...
        <div class="modal-dialog modal-fullscreen modal-dialog-centered">
            <div class="modal-content border-0" style="background-color:transparent">
                ...
                <div class="modal-header bg-dark text-white border-0">
                    ...
                    <i class="fa-solid fa-times" data-bs-dismiss="modal" aria-label="Close"></i>
                </div>
                <div class="modal-body d-flex" style="background-color:transparent">
                    <div class="container">
                        ...
                        <div id="carouselExampleIndicators" data-bs-touch="false" class="carousel slide mt-2 desktop" data-bs-ride="false">
                            ...
                            <div class="carousel-indicators custom scroll-simple">
                                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1">
                                    <img src="{{asset('')}}images/lahan1.jpeg" class="d-block w-100 image-kunam image-kunam" alt="...">
                                </button>
                                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" aria-label="Slide 2">
                                    <img src="{{asset('')}}images/lahan2.jpeg" class="d-block w-100 image-kunam image-kunam" alt="...">
                                </button>
                                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" aria-label="Slide 3">
                                    <img src="{{asset('')}}images/lahan3.jpeg" class="d-block w-100 image-kunam image-kunam" alt="...">
                                </button>
                                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="3" aria-label="Slide 4">
                                    <img src="{{asset('')}}images/lahan4.jpeg" class="d-block w-100 image-kunam image-kunam" alt="...">
                                </button>
                            </div>
                        ...
                        <div id="carouselExampleIndicatorsM" data-bs-touch="false" class="carousel slide mt-2 mobile" data-bs-ride="false">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="{{asset('')}}images/lahan1.jpeg" class="d-block image-kunam gambar-sesuai" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="{{asset('')}}images/lahan2.jpeg" class="d-block image-kunam gambar-sesuai" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="{{asset('')}}images/lahan3.jpeg" class="d-block image-kunam gambar-sesuai" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="{{asset('')}}images/lahan4.jpeg" class="d-block image-kunam gambar-sesuai" alt="...">
                                </div>
                            </div>
                            ...
                            <div class="carousel-indicators custom scroll-simple">
                                <button type="button" data-bs-target="#carouselExampleIndicatorsM" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1">
                                    <img src="{{asset('')}}images/lahan1.jpeg" class="d-block w-100 image-kunam" data-bs-toggle="modal" data-bs-target="#image-modal" data-src="{{asset('')}}images/lahan1.jpeg" alt="...">
                                </button>
                                <button type="button" data-bs-target="#carouselExampleIndicatorsM" data-bs-slide-to="1" aria-label="Slide 2">
                                    <img src="{{asset('')}}images/lahan2.jpeg" class="d-block w-100 image-kunam" data-bs-toggle="modal" data-bs-target="#image-modal" data-src="{{asset('')}}images/lahan1.jpeg" alt="...">
                                </button>
                                <button type="button" data-bs-target="#carouselExampleIndicatorsM" data-bs-slide-to="2" aria-label="Slide 3">
                                    <img src="{{asset('')}}images/lahan3.jpeg" class="d-block w-100 image-kunam" data-bs-toggle="modal" data-bs-target="#image-modal" data-src="{{asset('')}}images/lahan1.jpeg" alt="...">
                                </button>
                                <button type="button" data-bs-target="#carouselExampleIndicatorsM" data-bs-slide-to="3" aria-label="Slide 4">
                                    <img src="{{asset('')}}images/lahan4.jpeg" class="d-block w-100 image-kunam" data-bs-toggle="modal" data-bs-target="#image-modal" data-src="{{asset('')}}images/lahan1.jpeg" alt="...">
                                </button>
                            </div>
