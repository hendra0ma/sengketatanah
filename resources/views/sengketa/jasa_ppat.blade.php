                ...
                <div class="row g-2 mt-2 desktop">
                    ...
                    <div class="col-auto">
                        <form action="{{url('')}}/daftar-jasa"
                            method="get" id="form-ppat">
                            <input type="hidden" name="title"
                                value="PPAT">
                        </form>
                        <a onclick="return $('form#form-ppat').submit()" class="btn" style="background-color: #61481C; color: #fff">Daftar Sekarang</a>
                    </div>
                ...
                <div class="row g-0">
                    <div class="col-auto ms-auto" style="margin-top:5px">
                        <div class="d-grid gap-2 me-1">
                            <a onclick="return $('form#form-ppat').submit()" class="btn btn-sm btn-outline-brown rounded-5 fw-bold">Daftar Sekarang</a>
                        </div>
                    </div>

                    <div class="col me-auto" style="margin-top:5px">
                        <div class="ms-1 d-grid gap-2">
                            <a class="btn btn-sm btn-outline-brownie rounded-5 fw-bold" href="{{url('')}}/join">Pelajari Jasa PPAT</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card mt-3 border-0 shadow-sm">
                    <div class="card-body">
                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm">
                                                ...
                                                <table style="width:100%">
                                                    <tr>
                                                        <td rowspan="3">
                                                            <form action="{{url('')}}/detail-main-petugas" method="get" id="form-ppat-{{$i}}">
                                                            ...
                                                            <img onclick="return  $('form#form-ppat-<?= $i ?>').submit()" src="https://randomuser.me/api/portraits/men/{{$i}}.jpg" class="rounded-circle img-thumbnail " style="width:70px;height:auto;object-fit:cover;cursor: pointer;">
                                                        </td>
                                                        <td>
                                                            <b onclick="return  $('form#form-ppat-<?= $i ?>').submit()" style="cursor: pointer;" class="ms-1 text-success">
                                                                {{$name[$i]}}
                                                            </b>
                            ...
                            <div class="col-lg-4">
                                <img src="{{asset('')}}images/PPAT VIP_BANNER.jpg" class="img-fluid">
