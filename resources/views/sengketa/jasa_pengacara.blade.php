                ...
                <div class="row g-2 mt-2 desktop">
                    ...
                    <div class="col-auto">
                        <form action="{{url('')}}/daftar-jasa"
                            method="get" id="form-pengacara">
                            <input type="hidden" name="title"
                                value="Pengacara">
                        </form>
                        <a onclick="return $('form#form-pengacara').submit()" class="btn" style="background-color: #61481C; color: #fff">Daftar Sekarang</a>
                    </div>
                ...
                <div class="row g-0">
                    <div class="col-auto ms-auto" style="margin-top:5px">
                        <div class="d-grid gap-2 me-1">
                            <a onclick="return $('form#form-pengacara').submit()" class="btn btn-sm btn-outline-brown rounded-5 fw-bold">Daftar Sekarang</a>
                        </div>
                    </div>
