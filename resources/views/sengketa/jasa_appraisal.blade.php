                ...
                <div class="row g-0">
                    ...
                    <div class="col me-auto" style="margin-top:5px">
                        <div class="ms-1 d-grid gap-2">
                            <a class="btn btn-sm btn-outline-brownie rounded-5 fw-bold" href="{{url('')}}/join">Pelajari Jasa Appraisal</a>
                        </div>
                    </div>
                </div>
            </div>
                                                    ...
                                                    <table style="width:100%">
                                                        <tr>
                                                            <td rowspan="3">
                                                                ...
                                                                <img onclick="return  $('form#form-appraisal-<?= $i ?>').submit()"
                                                                    src="https://randomuser.me/api/portraits/men/{{$i}}.jpg"
                                                                    class="rounded-circle img-thumbnail "
                                                                    style="width:70px;height:auto;object-fit:cover;cursor: pointer;">
                                                            </td>
                                                            <td>
                                                                <b onclick="return  $('form#form-appraisal-<?= $i ?>').submit()"
