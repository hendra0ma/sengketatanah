  ...
  <body class="c-app">
    <div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
      ...
      <ul class="c-sidebar-nav">
        ...
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{url('/admin/add-news')}}">
            <svg class="c-sidebar-nav-icon">
            <use xlink:href="{{url('/')}}/core-ui/vendors/@coreui/icons/svg/free.svg#cil-pencil"></use>
            </svg> Add News</a></li>
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{url('/admin/all-news')}}">
            <svg class="c-sidebar-nav-icon">
              <use xlink:href="{{url('/')}}/core-ui/vendors/@coreui/icons/svg/free.svg#cil-menu"></use>
            </svg> All News</a></li>
        <li class="c-sidebar-nav-title">Sengketa Tanah</li>
       
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{url('/admin/sengketa-tanah')}}">
            <svg class="c-sidebar-nav-icon">
              <use xlink:href="{{url('/')}}/core-ui/vendors/@coreui/icons/svg/free.svg#cil-chart-pie"></use>
            </svg> Sengketa Tanah</a></li>
            {{-- <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{route('admin.hasil-bid-sengketa')}}">
              <svg class="c-sidebar-nav-icon">
                <use xlink:href="{{url('/')}}/core-ui/vendors/@coreui/icons/svg/free.svg#cil-chart-pie"></use>
